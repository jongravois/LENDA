...
class UsersController extends ApiController {
  ...
  {
    $users = User::with('client.location', 'staff.role', 'staff.location', 'clientprofile', 'staffprofile')->get();
  ...
  {
    $user = User::with('client.location', 'staff.role', 'staff.location', 'clientprofile', 'staffprofile')->where('id', $id)->get();
