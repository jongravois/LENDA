...
class LoansController extends ApiController
{
    ...
    {
        $loan = Loan::with('appfins', 'applicant.entitytype', 'applicant.state', 'committee.user', 'corporations', 'comments.responses', 'comments.status', 'disbursements', 'distributor', 'exceptions', 'cropexpenses.loancrop.crop', 'farmer.state', 'farms.county.states', 'loanconditions', 'loancrop.crop', 'loanstatus', 'loantype.reqdocs', 'location', 'inspols.agent', 'inspols.agency', 'inspols.county',  'inspols.crop', 'othercollateral', 'priorliens', 'quests', 'references', 'regions', 'suppins.counties', 'suppins.crops', 'systemics', 'user', 'ventures', 'xcollaterals')->where('id', $id)->get();
        //return $loans;  //REMOVE THIS
