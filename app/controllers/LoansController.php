...
class LoansController extends ApiController
{
    ...
    {
        $loans = Loan::with('appfins', 'applicant.entitytype', 'applicant.state', 'committee.user', 'corporations', 'comments.responses', 'comments.status', 'distributor', 'exceptions', 'farmer.state', 'farms.county', 'financials', 'loanconditions', 'loancrop.crop', 'loanstatus', 'loantype.reqdocs', 'location', 'othercollateral', 'partners', 'priorliens', 'regions', 'suppins.counties', 'suppins.crops', 'systemics', 'ventures', 'user')->where('applicant_id', '!=', 'null')->get();
    ...
    {
        $loan = Loan::with('appfins', 'applicant.entitytype', 'applicant.state', 'committee.user', 'corporations', 'comments.responses', 'comments.status', 'distributor', 'exceptions', 'farmer.state', 'farms.county', 'financials', 'loanconditions', 'loancrop.crop', 'loanstatus', 'loantype.reqdocs', 'location', 'othercollateral', 'partners', 'priorliens', 'regions', 'suppins.counties', 'suppins.crops', 'systemics', 'ventures', 'user')->where('applicant_id', '!=', 'null')->where('id', $id)->get();
        //return $loans;  //REMOVE THIS
