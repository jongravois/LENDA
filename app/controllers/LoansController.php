...
class LoansController extends ApiController {
  ...
  protected $notificationTransformer;
	...
	{
		$loans = Loan::with('applicants.entitytype', 'committee.user', 'corporations', 'distributor', 'farmer', 'farms.county', 'financials', 'insurance', 'loancrop.crop', 'loanstatus', 'loantype.reqdocs',  'location', 'partners', 'regions', 'staff', 'ventures', 'user')->where('applicant_id', '!=', 'null')->get();
	...
	{
		$loan = Loan::with('applicants.entitytype', 'committee.user', 'corporations', 'distributor', 'farmer', 'farms.county', 'financials', 'insurance', 'loancrop.crop', 'loanstatus', 'loantype.reqdocs',  'location', 'partners', 'regions', 'staff', 'ventures', 'user')->where('id', $id)->get();
		//return $loan;
