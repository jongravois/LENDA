...
class LoansController extends ApiController
{
    ...
    {
        $loans = Loan::with('appfins', 'applicant.entitytype', 'applicant.state', 'committee.user', 'corporations', 'comments.responses', 'comments.status', 'distributor', 'exceptions', 'cropexpenses.loancrop.crop', 'farmer.state', 'farms.county', 'financials', 'loanconditions', 'loancrop.crop', 'loanstatus', 'loantype.reqdocs', 'location', 'inspols.crop', 'othercollateral', 'priorliens', 'regions', 'suppins.counties', 'suppins.crops', 'systemics', 'user', 'ventures', 'xcollaterals')->where('applicant_id', '!=', 'null')->get();
